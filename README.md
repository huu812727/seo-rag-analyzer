...
Subprocess Logging: Все этапы (scraper -> vectorize -> analyzer -> translator) запускаются изолированло с жестким контролем stderr и выводом логов прямо в UI интерфейса.
